...
Route::post('sendContact', 'HomeController@sendContact')->name('send_contact');
Route::post('sendBooking', 'HomeController@sendBooking')->name('send_booking');
Route::post('searching', 'HomeController@searching')->name('searching');
//dreamcat
Route::get('searchart', 'admin\ProfileController@artistsdetail_searching')->name('searchart');
//////////
Route::get('searching/{id}', 'HomeController@getArtistDetails')->name('get_artist_details');
Route::post('filtering', 'HomeController@filtering')->name('filtering');
Route::get('filtering', 'HomeController@exploreMore')->name('explore-more');
Auth::routes();
...
Route::post('ajaxRequestone', 'AjaxController@ajaxRequestArtist')->name('ajaxRequestone.artist');
...
foreach (Page::all() as $page) {
    Route::get($page->slug, function() use($page){
        $file = fopen( resource_path( 'views/' . $page->slug . '.blade.php' ), 'w' );
...
Route::prefix('/admin')->middleware(['admin'])->group(function () {
    ...
    Route::post('get', 'admin\ArtistController@getArtistsAjax')->name('get-ajax-artist');
    ...
    Route::prefix('artists/{artist}')->group(function () {
        ...
        Route::prefix('profiles/{profileid}')->group(function(){
            ...
            Route::get('setprimarygallery', 'admin\ProfileController@setprimaryGallery');
            ...
            Route::get('showinfo', 'admin\ProfileController@showinfo')->name('showinfo');
            Route::post('addinfo', 'admin\ProfileController@addinfo')->name('addinfo');
            Route::get('editinfo', 'admin\ProfileController@editinfo')->name('editinfo');
            Route::get('deleteinfo', 'admin\ProfileController@deleteinfo')->name('deleteinfo');

            Route::post('updateinfo', 'admin\ProfileController@updateinfo')->name('updateinfo');


            Route::get('addReview', 'admin\ProfileController@addReview')->name('addReview');
            Route::post('storeReview', 'admin\ProfileController@storeReview')->name('storeReview');
...
//            Editing by dreamcat
    ...
    Route::get('email/{id}/forward', 'admin\MessageController@forward');
    ...
    Route::post('test', 'admin\MessageController@sendCompose');
    Route::post('forward', 'admin\MessageController@sendForward');
    ...
    Route::get('home/create', 'admin\PageController@createHome')->name('create_home');
    Route::post('home/store', 'admin\PageController@storeHomePage')->name('store_home');


    Route::get('reviews/add', 'admin\ClientReviews@clientsReviews')->name('clients_reviews');
    Route::post('reviews/store', 'admin\ClientReviews@store')->name('store_clients');
    Route::get('reviews/delete', 'admin\ClientReviews@delete')->name('delete_review');
    Route::get('reviews/update', 'admin\ClientReviews@update')->name('update_review');



    Route::get('footer/add', 'admin\FooterController@add')->name('add_footer');
    Route::post('footer/store', 'admin\FooterController@store')->name('store_footer');



    Route::get('quote/add', 'admin\QuoteController@add')->name('add_quote');
    Route::post('quote/add', 'admin\QuoteController@uploadImage')->name('upload_quote_image');
    Route::post('quote/store', 'admin\QuoteController@store')->name('store_quote');


    Route::get('findArtist/add', 'admin\FindArtistController@add')->name('add_find_artist');
    Route::post('findArtist/store', 'admin\FindArtistController@store')->name('store_find_artist');

    Route::get('artistDetails/add', 'admin\ArtistDetailsController@add')->name('add_artist_details');
    Route::post('artistDetails/store', 'admin\ArtistDetailsController@store')->name('store_artist_details');
...
Route::prefix('/backroom')->middleware(['client'])->group(function () {
    ...
    Route::prefix('/profiles')->group(function(){
        ...
        Route::prefix('/{id}')->group(function(){
            ...
            Route::get('setprimarygallery', 'client\ProfileController@setprimaryGallery');
