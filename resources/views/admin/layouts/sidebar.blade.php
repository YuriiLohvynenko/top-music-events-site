        ...
        <ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="{{ route('create_home') }}">Home page</a>
                    </li>
                    <li>
                        <a href="{{ route('add_find_artist') }}">Find Artist </a>
                    </li>
                    <li>
                        <a href="{{ route('add_artist_details') }}">Artist Details </a>
                    </li>
                    <li>
                        <a href="{{ route('add_quote') }}">Quotes </a>
                    </li>
                    <li>
                        <a href="{{ route('clients_reviews') }}">What Clients Say </a>
                    </li>
                    <li>
                        <a href="{{ route('add_footer') }}">Footer </a>
                    </li>
                    <li>
