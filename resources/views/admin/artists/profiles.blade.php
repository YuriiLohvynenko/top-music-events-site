...
{{--                                                        Editing by dreamcat--}}
{{--                                                        <li><a href="{{ route('artists.detail', ['artist' => $artist->id, 'profileid' => $profile->id]) }}" target="_blank">--}}
{{--                                                                View Profile--}}
{{--                                                            </a>--}}
{{--                                                        </li>--}}
                                                        <li><a href="{{ route('searching') }}" target="_blank" onclick="onFormSubmit({{ $profile->id }})">
                                                                <form action="{{ route('searching') }}" name="myForm{{ $profile->id }}" method="POST">
                                                                    @csrf
                                                                    <input type="hidden" value="{{ $profile->fullname }}" id="artist_id" name="artist_id">
                                                                </form>
                                                                View Profile
                                                            </a>
                                                        </li>
