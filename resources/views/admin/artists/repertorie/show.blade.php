        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a type="button" class="btn  btn-cons pull-left"
                    ...
                    Info</a>
                    <a type="button" class="btn  btn-cons pull-left"
                           href="{{ route('addReview', ['artist' =>  $profile->user->id, 'profileid' => $profile->id]) }}">REVIEW</a>
            </div>
        </div>
        <!-- ID CONTAINER -->
        <div id="container">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="grid simple ">
                        ...
                        <div class="grid-body ">
                            <div class="row">
                                <form action="{{ route('addrepertorie', ['artist' => $artist->user->id, 'profileid' => $artist->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="janre">Genre</label>
                                            <input type="text" name="janre" id="janre" style="width: 100%" placeholder="">
                                            <label for="janre">Up to 10 genres</label>
                                        ...
                                        <div class="list-group-item" style="overflow: hidden">
                                            ...
                                            <div class="col-md-3">
                                                <span class="text-center">
                                                    <a onclick="editaddon({{ $artist->id }}, {{ $repertorie->id }})" class="btn btn-danger">Save</a>
                                                    <a onclick="deleteaddon({{ $artist->id }}, {{ $repertorie->id }})" class="btn btn-secondary">Delete</a>
                                                    <span>
                                            </div>
                                        </div>
                                        @endforeach
