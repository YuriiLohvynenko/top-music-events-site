...
<body>
    ...
    <main role="main">
        ...
        <?php
        $pageimage = '';
        if(App\Models\ArtistImage::where('type', 'pageimage')->where('artist_id', $profileid)->exists()){
            $pageimage = App\Models\ArtistImage::where('type', 'pageimage')->where('artist_id', $profileid)->first()->url;
        }
        ?>
        <div class="top_section3" style="background: url({{ asset('uploads').'/'.$pageimage }});background-size: cover;">
            <div class="row" style="margin:0">
                <div class="col-md-12 top_box">
                    <h1>{{ App\Models\Artist::find($profileid)->fullname }}</h1>
                    <h5>FROM £1250</h5>
                </div>
            </div>
        </div>
                ...
                <div class="mt20 mb20">
                    <div class="row my_inner">
                        <div class="col-md-6 tracks center">
                            @foreach(App\Models\Artist::find($profileid)->artistmusic as $music)
                            <a href="#" class="hover">
        ...
        <div class="black_box">
            <div class="container">
                ...
                <div id="carouselExampleIndicators" class="carousel slide my_gallery" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        @foreach(App\Models\ArtistImage::where('artist_id', $profileid)->where('type',
            ...
            <?php
            $repimage = '';
            if(App\Models\ArtistImage::where('type', 'repimage')->where('artist_id', $profileid)->exists()){
                $repimage = App\Models\ArtistImage::where('type', 'repimage')->where('artist_id', $profileid)->first()->url;
            }
            ?>
            <div class="songs_box"
                ...
                <div class="container">
                    <div class="row pb70">
                        <div class="col-md-4">
                            <ul class="song_cats">
                                @foreach(App\Models\Artist::find($profileid)->artistrepertorie as $item)
                                ...
                                <div class="my_box2">
                                    ...
                                    <div class="search_form left" action="" method="POST">
                                        ...
                                        <select class="my_select3" name="location" id="location">
                                            @foreach (App\Models\Artist::find($profileid)->pricelocation as $item)
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="my_box2">
                                    ...
                                    <div class="search_form left">
                                        ...
                                        {{-- add ons --}}
                                        @foreach (App\Models\Artist::find($profileid)->priceaddon as $item)
                                        <div class="holder">
            ...
            <?php
            $reviewimage = '';
            if(App\Models\ArtistImage::where('type', 'reviewimage')->where('artist_id', $profileid)->exists()){
                $reviewimage = App\Models\ArtistImage::where('type', 'reviewimage')->where('artist_id', $profileid)->first()->url;
            }
            ?>
