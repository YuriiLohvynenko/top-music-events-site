            ...
            <div class="col-md-12">
                <div class="grid simple">
                    <div class="grid-body no-border" style="min-height: 850px;">
                        <br>
                        <div class="row-fluid ">
                            <form action="{{ action('admin\MessageController@sendCompose') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="controls">
                                            <select name="to[]" style="width: 100%;" id="multi" multiple required >
                                                <option value=""></option>
...
@section('styles')
<link href="{{ asset('adminn/assets/plugins/bootstrap-wysihtml5/wysiwyg-color.css') }}" rel="stylesheet"
    type="text/css" />
