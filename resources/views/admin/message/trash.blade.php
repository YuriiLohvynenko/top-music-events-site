...
<div class="page-content">
    <div class="content">
        <div class="page-title" style="display:none"> <a href="{{ action('admin\MessageController@trash') }}" id="btn-back"><i class="icon-custom-left"></i></a>
                                ...
                                <table class="table table-striped" id="sample_1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr message-id="{{ $message->id }}">
                                            ...
                                            <td class="clickable v-align-middle">{{ $message->from }}</td>
    ...
    <div class="admin-bar" id="quick-access" style="display:">
        <div class="admin-bar-inner">
            <button class="btn btn-danger  btn-add" type="button" onclick="recover();"><i class="icon-trash"></i> Recover</button>
            <button class="btn btn-warning  btn-add" type="button" onclick="fdelete();"><i class="icon-trash"></i> Forever Delete</button>
