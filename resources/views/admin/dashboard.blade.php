                ...
                <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
                    <div class="tiles blue added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="tiles-title"> NEW ARTISTS</div>
                            <div class="heading">
                                <span class="animate-number" data-value="{{App\Models\Artist::where('created_at', '>=', date('Y-m-d'))->count()}}" data-animation-duration="1200">0</span>
                            </div>
                            <div class="progress transparent progress-small no-radius">
                                <div class="progress-bar progress-bar-white animate-progress-bar"
                                    data-percentage="{{(App\Models\Artist::count()==0)? 0 : App\Models\Artist::where('created_at', '>=', date('Y-m-d'))->count() / App\Models\Artist::count() *100 }}%">
                                </div>
                            </div>
                    ...
                    <div class="tiles green added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="heading"> <span class="animate-number"
                                    data-value="{{ App\Models\Booking::where('created_at', '>=', date('Y-m-d'))->count() }}"
                                    data-animation-duration="1000">0</span> </div>
                            <div class="progress transparent progress-small no-radius">
                                <div class="progress-bar progress-bar-white animate-progress-bar" data-percentage="{{(App\Models\Booking::count()==0)? 0 : App\Models\Booking::where('created_at', '>=', date('Y-m-d'))->count() / App\Models\Booking::count() *100 }}%">
                                </div>
                            </div>
                            <div class="description">
                                <i class="icon-custom-up"></i>
                    ...
                    <div class="tiles red added-margin">
                        <div class="tiles-body">
                            <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;"
                                    class="remove"></a> </div>
                            <div class="tiles-title"> TODAY’S PAYMENTS </div>
                            <div class="heading"> £ <span class="animate-number" data-value="{{App\Models\Booking::where('paid_datetime', '>=', date('Y-m-d'))->where('status_id', 2)->sum('amount')}}"
                                    data-animation-duration="1200">0</span> </div>
                            <div class="progress transparent progress-white progress-small no-radius">
                                <div class="progress-bar progress-bar-white animate-progress-bar" data-percentage="{{(App\Models\Booking::where('status_id', 2)->sum('amount')==0)? 0 : App\Models\Booking::where('paid_datetime', '>=', date('Y-m-d'))->where('status_id', 2)->sum('amount') / App\Models\Booking::where('status_id', 2)->sum('amount') * 100}}%">
                                </div>
                            </div>
                            <div class="description"><i class="icon-custom-up"></i>
                                {{-- <span
                                    class="text-white mini-description ">&nbsp;
                                    5% higher <span class="blend">than last month</span></span> --}}
                                </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="tiles purple added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="row-fluid">
                                <div class="heading"> <span class="animate-number" data-value="{{App\Models\Message::where('created_at', '>=', date('Y-m-d'))->count()}}"
                                        data-animation-duration="700">0</span> </div>
                                <div class="progress transparent progress-white progress-small no-radius">
                                    <div class="progress-bar progress-bar-white animate-progress-bar"
                                        data-percentage="{{(App\Models\Message::count()==0)? 0 : App\Models\Message::where('created_at', '>=', date('Y-m-d'))->count() / App\Models\Message::count() *100 }}%"></div>
                                </div>
                            </div>
                            <div class="description"><i class="icon-custom-up"></i>
                                {{-- <span
                ...
                <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
                    <div class="tiles blue added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="tiles-title"> TOTAL ARTISTS</div>
                            <div class="heading">
                                <span class="animate-number" data-value="{{ App\Models\Artist::count() }}"
                ...
                <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
                    <div class="tiles green added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="heading">
                                <span class="animate-number" data-value="{{ App\Models\Booking::count() }}"
                ...
                <div class="col-md-3 col-sm-6 spacing-bottom">
                    <div class="tiles red added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="tiles-title"> TOTAL PAYMENTS </div>
                            <div class="heading">
                                £ <span class="animate-number"
                                    data-value="{{ App\Models\Booking::where('status_id', 2)->sum('amount') }}"
                            ...
                            <div class="grid-body ">
                                <table class="table table-striped" id="example2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            @if ($booking->id < 10)
                                                <td>TME00{{$booking->id}}</td>
                                            @elseif ($booking->id<100)
                                                <td>TME0{{$booking->id}}</td>
                                            @else
                                                <td>TME{{$booking->id}}</td>
                                            @endif
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a href="{{ route('booking.view', ['id'=>$booking->id]) }}">View Booking</a></li>
                                                        <li><a href="{{ route('artists.detail', ['artist'=>$booking->pricelocation->artist->user->id, 'profileid' => $booking->pricelocation->artist->id]) }}">View Artist</a></li>
                                                        <li><a href="{{ route('booking.contactcustomer', ['id'=>$booking->id]) }}">Contact Customer</a></li>
                                                        <li><a href="{{ route('booking.contactartist', ['id'=>$booking->pricelocation->artist->id]) }}">Contact Artist</a></li>
                                                        @if($booking->status_id == 1)
                                                            <li><a href="{{ route('profiles.showpayment', ['id'=>$booking->id])}}">Make a payement</a></li>
                                                        @endif
                                                        <li><a href="{{ route('booking.delete', ['id'=>$booking->id])}}">Remove Booking</a></li>
