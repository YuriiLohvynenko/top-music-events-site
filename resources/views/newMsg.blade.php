                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                            <tr>
                                <td style="color: #153643; font-family: Arial, sans-serif; width: 150px">
                                    <h1 style="font-size: 18px; margin: 0;">SUBJECT:</h1>
                                </td>
                                <td style="font-family: Arial, sans-serif;">
                                    <h1 style="font-size: 18px; margin: 0;">You have a new message</h1>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td bgcolor="#ffffff" style="padding: 5px 20px;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                            <tr>
                                <td style="color: #153643; font-family: Arial, sans-serif; width: 150px">
                                    <h1 style="font-size: 18px; margin: 0;">Link:</h1>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td bgcolor="#ffffff" style="padding: 5px 20px;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                            <tr>
                                <td style="font-family: Arial, sans-serif;">
                                    <h1 style="font-size: 18px; margin: 0;">{{ url('/backroom/login') }}</h1>
                                </td>
                            </tr>
                        </table>
                    </td>
